/* 
 * Pre-emptive shortest-remaining-time-next (SRTN) scheduling algorithm
 * Created at [2026-07-14] authored by [Fuad]
 */
...
void enq_process(queue<Process>& process_q, uint32_t n)
{
    ...
    for (auto& [pid, at, ct] : p)
    {
        process_q.emplace(pid, at, ct);
...
/*
    [Gantt chart] 0-P0:1----P1:5-----P3:10-------P0:17---------P2:26
    PID   AT   CT   ST   FT   TT   WT   RT
     P3    3    5    5   10    7    2    2
     P2    2    9   17   26   24   15   15
     P1    1    4    1    5    4    0    0
     P0    0    8   10   17   17    9   10
    Average TT 13.000
    Average WT 6.500
    Average RT 6.750
*/
